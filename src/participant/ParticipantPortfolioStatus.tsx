...
import type { Participant } from "../domain/participant/participantTypes.ts";
	...
	return (
		<Card elevation={0} sx={{ mt: "1rem", mb: "2rem" }}>
			<CardContent>
				...
				<Typography>
					Investments value : {totalInvestmentValue.toFixed(2)} USD
				</Typography>
				<Divider sx={{ m: "0.5rem 0" }} />
				<Typography>Total value : {totalValue.toFixed(2)} USD</Typography>
			</CardContent>
		</Card>
	);
};
