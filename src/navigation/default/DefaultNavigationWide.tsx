            ...
            <Toolbar sx={{height: "100%"}}>
                <Container maxWidth="xl" sx={{display: "flex", justifyContent: "space-between", height: "100%"}}>
                    <Box sx={{display: "flex", alignItems: "center", gap: 10}}>
                        <Typography sx={{color: appTheme.palette.primary.contrastText, fontWeight: "bold", fontSize: "large"}}>
                            STOCK COMP
                        </Typography>
                    ...
                    <Box sx={{display: "flex", alignItems: "center", gap: 6}}>
                        <StyledIconButton icon={appTheme === darkTheme ? <SunnyIcon/> : <NightlightIcon/>}
                                          onClick={toggleTheme}/>
