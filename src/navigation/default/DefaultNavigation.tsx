                ...
                <Toolbar sx={{height: "100%"}}>
                    <Container maxWidth="xl" sx={{
                        ...
                        <Box sx={{display: "flex", alignItems: "center", gap: 10}}>
                            <Typography sx={{color: "white", fontWeight: "bold"}}>STOCK COMP</Typography>
                            <NavigationButton to="/symbols" buttonText="Symbols"/>
                            <Button component={Link} to="/leaderboard">Leaderboard</Button>
                            <Button component={Link} to="/contests">Contests</Button>
                            <Button component={Link} to="/account">Accounter</Button>
                        </Box>
